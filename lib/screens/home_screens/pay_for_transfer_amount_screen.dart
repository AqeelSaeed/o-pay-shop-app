...
class PayForTransferAmountScreen extends StatefulWidget {
  final double transferCode;
  const PayForTransferAmountScreen({super.key, required this.transferCode});

  @override
  State<PayForTransferAmountScreen> createState() =>
      _PayForTransferAmountScreenState();
}

class _PayForTransferAmountScreenState
    extends State<PayForTransferAmountScreen> {
                    ...
                    Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(
                            '${LocaleKeys.transferCode.tr()}: ${widget.transferCode}',
                            style: Styles.regularText
                                .copyWith(color: Colors.white),
                          ),
                        ],
